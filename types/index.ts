...
export type ExerciseDraftSource = "Wellth Plan" | "Work on Me";

export interface ExerciseDraftEntry {
  id: string;
  title: string;
  description?: string;
  category?: string;
  category_id?: string;
  sub_type?: "feelings" | "focus" | "wealth_plan";
  source: ExerciseDraftSource;
  sort_order: number | null;
  is_draft: boolean;
  last_updated: string;
}

export const EXERCISE_DRAFT_TABS = [
  "All Exercise",
  "Work on Me (7 Days)",
  "Wellth plan (30 Days)",
] as const;

export type ExerciseDraftTab = (typeof EXERCISE_DRAFT_TABS)[number];
